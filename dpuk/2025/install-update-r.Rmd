...
Download the installer: https://cran.r-project.org/bin/windows/base/R-4.4.2-win.exe
...
- If you have a Windows 64-bit PC (most likely) click here: https://cran.r-project.org/bin/windows/Rtools/rtools44/files/rtools44-aarch64-6414-6401.exe
...
1. Download this if you have an Apple M1-M3 macOS PC: https://cran.r-project.org/bin/macosx/big-sur-arm64/base/R-4.4.2-arm64.pkg

2. Download this if you have an older Intel-based macOS PC: https://cran.r-project.org/bin/macosx/big-sur-x86_64/base/R-4.4.2-x86_64.pkg
