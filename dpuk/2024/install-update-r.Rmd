...
Download the installer: https://cran.r-project.org/bin/windows/base/R-4.3.3-win.exe
...
1. Download this if you have an Apple M1-M3 macOS PC: https://cran.r-project.org/bin/macosx/big-sur-arm64/base/R-4.3.3-arm64.pkg

2. Download this if you have an older Intel-based macOS PC: https://cran.r-project.org/bin/macosx/big-sur-x86_64/base/R-4.3.3-x86_64.pkg
